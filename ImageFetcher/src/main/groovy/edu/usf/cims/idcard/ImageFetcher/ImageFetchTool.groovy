            ...
            try {
              idsql.eachRow({ o ->
                if (o.all) {
                  ...
                  return """SELECT ID.ID_PERSON AS USFID FROM IDCARD.ID WHERE ID.ID_IMAGE_FILE_NAME IS NOT NULL AND ID.ID_PERSON LIKE ${o.usfid.value as String} GROUP BY ID.ID_PERSON"""
                } else {
